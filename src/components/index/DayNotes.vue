              ...
              <el-carousel-item v-for="types in item_types" :key="types">
                <div class="types-container">
                  <div class="column" v-for="column in types" :key="column">
                    <el-tag v-for="type in column" :key="type">
                  ...
                  <div class="column">
                    <el-tag>
                      <icon name="shopping-cart" width="2rem" height="2rem"></icon>
                      <p class="text-xs">购 物</p>
                    </el-tag>
                    <el-tag>
                      <icon name="user" width="2rem" height="2rem"></icon>
                      <p class="text-xs">个 人</p>
                    </el-tag>
                    <el-tag>
                      <icon name="film" width="2rem" height="2rem"></icon>
                      <p class="text-xs">电 影</p>
                    </el-tag>
                    <el-tag>
                      <icon name="users" width="2rem" height="2rem"></icon>
                      <p class="text-xs">社 交</p>
                    </el-tag>
                    <el-tag>
                      <icon name="bus" width="2rem" height="2rem"></icon>
                      <p class="text-xs">公 交</p>
                    </el-tag>
                  </div>
                </div>
              </el-carousel-item>
  ...
  methods: {
    ...
    stopDrag: function () {
      if (this.dragging) {
        ...
        const vm = this
        if(this.c.y >= 72){
          const item = { cost: Math.floor(0.00) }
